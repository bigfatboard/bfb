...
/* oxlint-disable */
// Protocol: bfb-wire/1
// Schema hash: 0235e04050cdf1bca908db9cf3f2fdf7411fe5286b1d3c51b4970b7045b370e9
...
function validate42(
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    for (const key0 of Object.keys(data)) {
      if (!func0.call(schema117.properties, key0)) {
        const err9 = {
          instancePath,
          schemaPath: "#/additionalProperties",
          keyword: "additionalProperties",
    ...
    if (data.status !== void 0 && func0.call(data, "status")) {
      ...
      if (!(
        ...
        const err35 = {
          ...
          keyword: "enum",
          params: { allowedValues: schema117.properties.status.enum },
          message: "must be equal to one of the allowed values",
        };
        if (vErrors === null) {
          vErrors = [err35];
    ...
    if (data.kind !== void 0 && func0.call(data, "kind")) {
      ...
      if (!(
        ...
        const err54 = {
          ...
          schemaPath: "#/properties/kind/enum",
          keyword: "enum",
          params: { allowedValues: schema126.properties.kind.enum },
          message: "must be equal to one of the allowed values",
        };
        if (vErrors === null) {
          vErrors = [err54];
    ...
    if (data.capture_origin !== void 0 && func0.call(data, "capture_origin")) {
      ...
      if (!(
        ...
        const err61 = {
          ...
          keyword: "enum",
          params: { allowedValues: schema126.properties.capture_origin.enum },
          message: "must be equal to one of the allowed values",
        };
        if (vErrors === null) {
          vErrors = [err61];
