...
func RegisterDaemon(registry *Registry, methods *daemon.Registry) {
	...
	register(Command{Path: "mcp stdio", Method: "mcp.stdio", Summary: "Reserved; capability not implemented yet", Run: func(_ context.Context, _ Invocation) (map[string]any, error) {
