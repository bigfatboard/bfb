// ABOUTME: Proxies A03 commands from independent Worker isolates to one external WorkspaceHub.
...
interface ResultWorkerEnv {
  WORKSPACE_HUB: HubNamespace;
}

export default {
  async fetch(request: Request, env: ResultWorkerEnv): Promise<Response> {
