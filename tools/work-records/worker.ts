// ABOUTME: Proxies C08 commands from independent Worker isolates to one external WorkspaceHub.
...
interface WorkRecordWorkerEnv {
  WORKSPACE_HUB: HubNamespace;
}

export default {
  async fetch(request: Request, env: WorkRecordWorkerEnv): Promise<Response> {
